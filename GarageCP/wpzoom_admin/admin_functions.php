...
$themename = "GarageCP Theme";
$shortname =  "wpzoom";

$options = array (

array(    "name" => "GarageCP Theme Settings",
        "type" => "title"),
...
array(    "type" => "preheader",
          "name" => "Homepage/Archive Posts Display Options (Meme Center)"),
...
array(    "name" => "Thumbnail Height (in pixels)",
        "desc" => "Default: <strong>120</strong> (pixels)",
...
array(    "name" => "Homepage Layout Style",
        "desc" => "<strong>Magazine Style</strong>: You can add widgets and featured categories from <a href='widgets.php' target='_blank'>Widgets page</a><br/><br/><strong>Meme Center</strong>: You can change the number of posts from <a href='options-reading.php' target='_blank'>Reading Settings</a>",
          "id" => $shortname."_homepage_style",
        "options" => array('Magazine Style','Meme Center'),
        "std" => "Magazine Style",
        "type" => "select"),
        
      
array(    "type" => "preheader",
          "name" => "Category Excluder (from Recent Posts in Meme Center layout)"),   
...
array(    "name" => "Header Banner Code",
        "desc" => "Enter complete HTML code for your banner or Adsense code.<br/>Recommended size: <strong> 468 &times; 60px</strong><br /><br /><em>Example:</em><br /><code>&lt;a href='http://garagecp.com'&gt;&lt;img src='http://garagecp.com/wp-images/Ads/header_ad.png' /&gt;&lt;/a&gt;</code>",
        "id" => $shortname."_ad_head_code",
        "std" => "Copy exmaple beside here...",
        "type" => "textarea"),
...
array(    "name" => "Sidebar Banner Code",
        "desc" => "Enter complete HTML code for your banner or Adsense code.<br />Recommended size: <strong> 250 &times; 250px</strong><br /><br /><em>Example:</em><br /><code>&lt;a href='http://ammancinemas.com' target='_blank'&gt;&lt;img src='http://garagecp.com/wp-images/Ads/sidebar_ad.png' /&gt;&lt;/a&gt;</code>",
...
array(    "name" => "Content Banner Code",
        "desc" => "Enter complete HTML code for your banner or Adsense code.<br/>Recommended size: <strong> 468 &times; 60px</strong><br /><br /><em>Example:</em><br /><code>&lt;a href='http://garagecp.com'&gt;&lt;img src='http://garagecp.com/wp-images/Ads/post_ad.png' /&gt;&lt;/a&gt;</code>",
...
<div id="zoomWrap">
  <div id="zoomHead">
    ...
    <div id="zoomTheme"><h3><?php echo "$themename $theme_data[Version] "; ?></h3></div>
    <div id="zoomInfo"><ul><li class="documentation"><a href="http://www.wpzoom.com/documentation/sportpress">Documentation</a></li><li class="support"><a href="http://www.wpzoom.com/forum" target="_blank">Support Forum</a></li></ul></div>
  </div>
