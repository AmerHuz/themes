...
function wpzoom_popular_posts ($args) { 
        ...
        $wrappeddate = date("F j, Y", mktime($datearray[3], $datearray[4], $datearray[5], $datearray[1], $datearray[2], $datearray[0]));
			...
			echo "<li class='mcpitem mcpitem-0'>". __('لا يوجد تعليقات') . "</li>\n";
		}
...
$wpzoomColors['darkred'] = 'Dark Red';
$wpzoomColors['green'] = 'Green';
$wpzoomColors['litegreen'] = 'Light Green';
$wpzoomColors['darkgreen'] = 'Dark Green';
$wpzoomColors['gray'] = 'Gray';
$wpzoomColors['litegray'] = 'Light Gray';
$wpzoomColors['darkgray'] = 'Dark Gray';
...
?>
        ...
        <div id="carousel-<?php echo $this->get_field_id('id'); ?>" class="jcarousel">
			...
			<div class="cleaner">&nbsp;</div>
			<div class="jcarousel-prev" style="display: block;" disabled="false">&laquo; <?php _e('السابق', 'wpzoom'); ?></div>
			<div class="jcarousel-next" style="display: block;" disabled="false"><?php _e('التالي', 'wpzoom'); ?> &raquo;</div>
