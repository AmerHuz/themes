  ...
  <body>
    ...
    <div class = "config"> 
		...
		<table>		
			...
			<tr><td>Watermark: </td><td><textarea id = "textbox3" cols = "25" rows = "2" ><?php  echo $site;  ?></textarea></td><td id = "watermarkplus"><img src  ='<?php echo $plus; ?>' height = '35' width = '35' /></td><td id = "watermarkminus"><img src  ='<?php echo $minus; ?>' height = '35' width = '35' /></td></tr>
