					...
					<li>
						...
						<div class="postcontent">
							...
							<div class="meta">
								...
								<?php if ($wpzoom_home_comm == 'Show') { ?><span class="comm_icon"><a href="<?php the_permalink() ?>#commentspost" title="Jump to the comments"><?php comments_number(__('لا يوجد تعليقات', 'wpzoom'),__('تعليق واحد', 'wpzoom'),__('% تعليقات', 'wpzoom')); ?></a></span><?php } ?>

							

								<span><?php edit_post_link( __('تعديل', 'wpzoom'), '', ''); ?></span>
				...
				<div class="cleaner">&nbsp;</div>
					...
					<div class="navigation">
						...
						<?php if (function_exists('wp_pagenavi')) { wp_pagenavi(); } else { ?>
							...
							<div class="floatleft"><?php next_posts_link( __('&larr; الصفحة السابقة', 'wpzoom') ); ?></div>

							<div class="floatright"><?php previous_posts_link( __('الصفحة التالية &rarr;', 'wpzoom') ); ?></div>
					...
					<p class="title"><?php _e('لا يوجد نتائج لهذه المعايير', 'wpzoom');?></p>
